...
class LogController(BaseController):
    ...
    @ex(
        help='Test the logging system by printing message of all levels'
    )
    def log_test(self):
        """Example sub-command."""
    ...
    @ex(
        help='Test the method to dump an object'
    )
    ...
    @ex(
        help='Test the method to dump a (complex) object, like an instance or a Class'
    )
